...
namespace Spirit604.DotsCity.Gameplay.Player
{
    public class PlayerSpawnTrafficControlService : MonoBehaviour, IPlayerSpawnerService
    {
        ...
        public void Initialize()
        {
            ...
            DefaultWorld.GetOrCreateSystemManaged<PlayerTrafficControlInitSystem>().Initialize(this);
            DefaultWorld.GetOrCreateSystemManaged<PlayerTrafficNextSwitchTargetNodeSystem>().Initialize(this);
