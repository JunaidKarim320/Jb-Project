...
namespace Spirit604.DotsCity.Simulation.Pedestrian
{
    ...
    public class PedestrianTestAnimationSpawnerConfig : ScriptableObject
    {
        [SerializeField] private NpcRigType npcRigType;
        ...
        public NpcRigType NpcRigType { get => npcRigType; set => npcRigType = value; }
        ...
        private bool HybridSkin => npcRigType == NpcRigType.HybridLegacy;

        private bool GPUSkin => npcRigType == NpcRigType.PureGPU;
    }
}
