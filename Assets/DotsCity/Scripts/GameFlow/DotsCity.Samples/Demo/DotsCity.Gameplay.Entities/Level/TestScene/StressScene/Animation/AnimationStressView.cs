...
namespace Spirit604.DotsCity.Simulation.Pedestrian
{
    public class AnimationStressView : MonoBehaviour
    {
        ...
        public event Action<NpcRigType> OnNpcTypeChanged = delegate { };
        ...
        private void Awake()
        {
            configEnumValueItem.Initialize("NpcRigType", default, typeof(NpcRigType), (val) => OnNpcTypeChanged((NpcRigType)val));
        ...
        public void Initialize(NpcRigType npcRigType)
        {
