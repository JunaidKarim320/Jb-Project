    ...
    public class PathEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Action settingsValuesCallback = () =>
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("pathCurveType"));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("pathRoadType"));
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("pathSpeedLimit"));
