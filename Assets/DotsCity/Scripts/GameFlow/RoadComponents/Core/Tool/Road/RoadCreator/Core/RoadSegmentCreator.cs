...
namespace Spirit604.CityEditor.Road
{
    ...
    public partial class RoadSegmentCreator : MonoBehaviour
    {
        ...
        public float LaneWidth => !customLaneWidthEnabled ? roadSegmentCreatorConfig.LaneWidth : customLaneWidth;
        public float CustomLaneWidth
        {
            get => customLaneWidth;
            set
            {
                if (customLaneWidth != value)
                {
                    customLaneWidth = value;
                    customLaneWidthEnabled = true;
                    EditorSaver.SetObjectDirty(this);
                }
            }
        }
        public float DividerWidth => IsCustom() ? dividerWidth : 0;
        public float SubLaneWidth => roadSegmentCreatorConfig.SubLaneWidth;
        ...
        public Vector3 CrossWalkOffset => !uniqueCrossWalkOffset ? roadSegmentCreatorConfig.CrossWalkOffset : customCrossWalkOffset;
        ...
        public void SnapNodes(bool recordUndo = true, bool includeRotation = false, GameObject customSnapObject = null)
        {
            ...
            IterateAllNodes(trafficNode =>
            {
                ...
                trafficNode.IterateAllPaths(callback, true);
#endif
            });
