...
namespace Spirit604.Gameplay.Road
{
    ...
    public class TrafficGroupMaskDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(rect1, trafficMaskGroupProp, new GUIContent("Traffic Mask Group"));
            ...
            switch (trafficMaskGroup)
            {
                case TrafficGroupMask.MaskType.Allowed:
                    EditorGUI.PropertyField(rect2, trafficTypeAllowedProp, new GUIContent("Traffic Group"));
                    break;
                case TrafficGroupMask.MaskType.Forbidden:
                    EditorGUI.PropertyField(rect2, trafficTypeForbiddenProp, new GUIContent("Traffic Group Forbidden"));
                    break;
