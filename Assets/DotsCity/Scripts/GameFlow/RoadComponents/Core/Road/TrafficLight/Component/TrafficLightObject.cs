...
namespace Spirit604.Gameplay.Road
{
    public class TrafficLightObject : MonoBehaviour
    {
        ...
        public int ConnectedId => connectedId;

        public TrafficLightFrameDataDictionary TrafficLightFrames { get => trafficLightFrameData; set => trafficLightFrameData = value; }
        ...
        public List<int> GetLightIndexes()
        {
            return trafficLightFrameData.Keys.ToList();
        }
