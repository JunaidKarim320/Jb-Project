...
namespace Spirit604.Gameplay.Road
{
    ...
    public class PedestrianNode : MonoBehaviour, IBakeRoad
    {
...
#if UNITY_EDITOR
        private bool CreatorSelected => PedestrianNodeCreator != null && Selection.activeGameObject == PedestrianNodeCreator.gameObject;
...
#if UNITY_EDITOR
                Undo.RegisterCompleteObjectUndo(newNode, "Pedestrian Node Connection Changed");
                ...
                else
                {
                    ...
                    if (newLineNodes.Count > 0)
                    {
                        ...
                        for (int i = 0; i < newLineNodes.Count; i++)
                        {
                            ...
                            Undo.RegisterCompleteObjectUndo(newLineNode, "Pedestrian Node Connection Changed");
                        }
        ...
        {
#if UNITY_EDITOR
            Undo.RegisterCompleteObjectUndo(this, "Pedestrian Node Connection Changed");
#endif
        }
        ...
        private bool ShouldDebug()
        {
            ...
            {
                shouldDebug = PathDebugger.ShouldDrawPedestrianConnectionPath;
            }
