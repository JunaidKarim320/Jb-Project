...
namespace Spirit604.DotsCity.Simulation.Pedestrian
{
    ...
    public partial class RagdollSystem : SystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            npcDeathEventConsumerSystem = World.GetOrCreateSystemManaged<NpcDeathEventConsumerSystem>();
        ...
        protected override void OnUpdate()
        {
            ...
            //ref var poolNoRagdollSystemRef = ref World.DefaultGameObjectInjectionWorld.Unmanaged.ResolveSystemStateRef(poolNoRagdollSystem);
            //var depJob = poolNoRagdollSystemRef.Dependency;
        ...
        public void Initialize(PedestrianRagdollSpawner pedestrianRagdollSpawner)
        {
