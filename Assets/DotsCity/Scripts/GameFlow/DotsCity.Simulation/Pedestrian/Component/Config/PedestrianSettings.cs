...
namespace Spirit604.DotsCity.Simulation.Pedestrian
{
    public struct PedestrianSettings
    {
        ...
        public bool HasLegacySkin => RigType == NpcRigType.HybridLegacy || RigType == NpcRigType.HybridAndGPU;
        public bool HasGPUSkin => RigType == NpcRigType.PureGPU || RigType == NpcRigType.HybridAndGPU;
