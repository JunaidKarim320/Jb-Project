...
namespace Spirit604.DotsCity.Simulation.Pedestrian
{
    ...
    public class PedestrianSpawnerConfig : ScriptableObject
    {
        private const int MaxPoolSize = 101000;
        private const int MaxPedestrianCount = 100000;
        ...
        [SerializeField][Range(0, 100)] private int maxPedestrianPerNode;
        ...
        public int MaxPedestrianPerNode { get => maxPedestrianPerNode; }
