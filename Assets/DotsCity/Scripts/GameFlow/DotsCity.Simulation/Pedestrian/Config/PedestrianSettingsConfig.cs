...
namespace Spirit604.DotsCity.Simulation.Pedestrian
{
    ...
    public class PedestrianSettingsConfig : ScriptableObject
    {
        ...
        public bool OnlyDummy => PedestrianSkinType == NpcSkinType.DummyShowAlways || PedestrianSkinType == NpcSkinType.DummyShowOnlyInView;
        public bool HasRig => PedestrianSkinType == NpcSkinType.RigShowOnlyInView || PedestrianSkinType == NpcSkinType.RigShowAlways || PedestrianSkinType == NpcSkinType.RigAndDummy;

        public bool GPUHybridSkin => pedestrianRigType == NpcRigType.HybridAndGPU;
        public bool HybridSkin => pedestrianRigType == NpcRigType.HybridAndGPU || pedestrianRigType == NpcRigType.HybridLegacy;
