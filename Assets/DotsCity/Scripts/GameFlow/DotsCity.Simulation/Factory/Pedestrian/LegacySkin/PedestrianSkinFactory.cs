...
{
    public class PedestrianSkinFactory : MonoBehaviour, IPedestrianRagdollPrefabProvider, IPedestrianSkinInfoProvider
    {
        #region Consts
...
#pragma warning restore 0414
        ...
        private void InitPool(PedestrianSpawnerConfigHolder pedestrianSpawnerConfigHolder)
        {
            ...
            if (pedestrianSettingsConfig.OnlyDummy)
            {
                return;
            }
        ...
        public void OnInspectorEnabled()
        {
            ...
            if (!pathExist)
            {
                prefabSavePath = CityEditorBookmarks.OBJECT_ROOT_PATH + DefaultSavePath;
            }
