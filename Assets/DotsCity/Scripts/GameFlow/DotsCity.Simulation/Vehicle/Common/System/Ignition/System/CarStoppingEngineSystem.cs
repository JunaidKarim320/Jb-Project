...
namespace Spirit604.DotsCity.Simulation.Car
{
    ...
    public partial struct CarStoppingEngineSystem : ISystem
    {
        ...
        public partial struct StoppingEngineJob : IJobEntity
        {
            ...
            {
                var updateSound = SoundLevelConfigReference.Config.Value.HasSounds && (carSoundData.CarSoundType != CarSoundType.Driving || carSoundData.SoundEntity == Entity.Null);
                ...
                if (SoundLevelConfigReference.Config.Value.HasSounds && carSoundData.CarSoundType == CarSoundType.Driving && SoundVolumeLookup.HasComponent(carSoundData.SoundEntity))
                {
