    ...
    public partial struct TrainMonoMovementSystem : ISystem
    {
        ...
        void ISystem.OnUpdate(ref SystemState state)
        {
                ...
                .WithAll<TrafficCustomMovementTag, AliveTag, TrainTag>())
            {
                ...
                var localTransform = LocalTransform.FromPositionRotation(transform.Value.position, transform.Value.rotation);
                ...
                newPos.y = transform.Value.position.y;

                rb.Value.Move(newPos, newRotation);
            };
        }
    }
}