    ...
    public partial struct TrafficPublicIdleSystem : ISystem
    {
        ...
        void ISystem.OnCreate(ref SystemState state)
        {
            updateQuery = SystemAPI.QueryBuilder()
                .WithDisabledRW<TrafficPublicProccessExitTag>()
                ...
                .WithAll<TrafficPublicIdleSettingsComponent, CarCapacityComponent, TrafficNodeLinkedComponent>()
                .Build();
        ...
        void ISystem.OnUpdate(ref SystemState state)
        {
            ...
            trafficPublicIdleJob.Schedule(updateQuery);
        }
        ...
        public partial struct TrafficPublicIdleJob : IJobEntity
        {
            ...
            {
                if (!trafficPublicIdleComponent.IsInitialized)
                {
                    trafficPublicIdleComponent.IsInitialized = true;
