...
namespace Spirit604.DotsCity.Simulation.Traffic
{
    ...
    public partial struct TrafficProcessEntereredTriggerTrafficNodeSystem : ISystem
    {
        ...
        void ISystem.OnUpdate(ref SystemState state)
        {
            ...
            enteredTrafficNodeJob.Schedule(carQuery);
        }
                ...
                in LocalTransform transform)
            {
                ...
                if (linked)
                {
                    ...
                    if (settingsComponent.TrafficNodeType == TrafficNodeType.Parking)
                    {
                        ...
                        InteractCarUtils.ExitCar(ref CommandBuffer, ref soundConfig, SoundPrefabEntity, transform.Position, carModelComponent.Value);
