...
namespace Spirit604.DotsCity.Simulation.Traffic.Authoring
{
    ...
    public class TrafficCarSettingsConfig : ScriptableObject
    {
        ...
        [SerializeField][Range(0, 100)] private float defaultLaneSpeed = ProjectConstants.DefaultLaneSpeed;

        [OnValueChanged(nameof(SettingsUpdated))]
        [Label("Max Car Speed Km/h")]
        [Tooltip("Maximum speed of the car")]
        [SerializeField][Range(0, 100)] private float maxCarSpeed = 60f;
        ...
        [OnValueChanged(nameof(SettingsUpdated))]
        [HideIf(nameof(CustomPhysicsEntity))]
        [Tooltip("Max steer angle of the wheels")]
        ...
        private bool CustomPhysicsEntity => EntityType == EntityType.HybridEntityCustomPhysics || EntityType == EntityType.PureEntityCustomPhysics || EntityType == EntityType.HybridEntityMonoPhysics;
