...
namespace Spirit604.CityEditor
{
    public class CityEditorBookmarks
    {
        ...
        public static string OBJECT_ROOT_PATH
        {
            get
            {
#if UNITY_EDITOR
        ...
        public static string PREFAB_ROOT_PATH => OBJECT_ROOT_PATH + "Prefabs/CityEditor/";
        public static string PREFAB_GAMEFLOW_ROOT_PATH => OBJECT_ROOT_PATH + "Prefabs/GameFlow/";
