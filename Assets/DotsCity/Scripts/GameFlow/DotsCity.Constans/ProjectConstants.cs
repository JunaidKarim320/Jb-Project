namespace Spirit604
{
    public static class ProjectConstants
    {
        ...
        public const int GroundLayer = 22;

        /// <summary>Ragdoll collider layer. </summary>
        public const int RagdollLayer = 28;

        /// <summary>Static object collider layer (e.g. house, fence). </summary>
        public const int PhysicsShapeLayer = 29;
        ...
        public const int DEFAULT_TRAFFIC_LAYER_VALUE = 26;

        /// <summary>Player & custom NPCs layer. </summary>
        public const int NPC_LAYER_VALUE = 27;
