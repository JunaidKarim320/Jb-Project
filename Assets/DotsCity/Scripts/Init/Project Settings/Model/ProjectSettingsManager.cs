...
namespace Spirit604.PackageManagerExtension
{
    ...
    public class ProjectSettingsManager : ScriptableObject
    {
        ...
        private const int DefaultProjectSceneCount = 13;
        ...
        private string GetCloneAssetPath(string assetName) => CityEditorBookmarks.OBJECT_ROOT_PATH + $"Prefabs/Init/{assetName}Clone.asset";
        private string GetClonePackagePath(string assetName) => CityEditorBookmarks.OBJECT_ROOT_PATH + $"Prefabs/Init/{assetName}Clone.unitypackage";
