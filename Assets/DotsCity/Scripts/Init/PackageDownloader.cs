...
namespace Spirit604.PackageManagerExtension
{
    public class PackageDownloader : PackageWindowBase
    {
        ...
        private const string EntitiesVersionFull = "1.3.2";
...
#pragma warning restore 0414
        ...
        private string ProjectSettingsManagerPath => CityEditorBookmarks.OBJECT_ROOT_PATH + "Prefabs/Init/ProjectSettingsManager.asset";
        ...
        protected override void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox($"Warning! Unity LTS versions 2022.3.40, 2022.3.41, 2022.3.42, 2022.3.43, 2022.3.44, 2022.3.45, 2022.3.46, 2022.3.47, 2022.3.48 are currently broken, plz install Unity 2022.3.39", MessageType.Error);
        ...
        protected override Dictionary<string, PackageData> LoadRequirePackageData()
        {
            ...
            var requirePackages = new Dictionary<string, PackageData>()
            {
                ...
                { "com.unity.entities.graphics", new PackageData()
                {
                    ...
                    PackageLoadPath = $"com.unity.entities.graphics@{EntitiesVersionFull}",
                    MinVersion = EntitiesVersion
                }},
                ...
                { "com.unity.cinemachine", new PackageData()
                {
                    ...
                    PackageLoadPath = "com.unity.cinemachine@2.10.1",
                    DefaultIndex = 0,
                    ...
                    Variants = new List<PackageDataBase>()
                    {
                        new PackageData()
                        {
                            PackageName = "com.unity.cinemachine 2.10.1",
                            PackageLoadPath = "com.unity.cinemachine@2.10.1",
                            MinVersion = "2.0.0",
                        },
                        new PackageData()
                        {
                            PackageName = "com.unity.cinemachine 3.1.1",
                            PackageLoadPath = "com.unity.cinemachine@3.1.1",
                            MinVersion = "3.0.0",
                            OnPackageInstall = () =>
                            {
                                AssetDatabase.ImportPackage($"{PackagePath}Main Camera City CM_v3.unitypackage", false);
                            },
                            OnProjectInstall = () =>
                            {
