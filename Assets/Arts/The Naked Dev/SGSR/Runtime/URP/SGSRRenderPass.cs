...
namespace TND.SGSR
{
    public class SGSRRenderPass : ScriptableRenderPass
    {
        ...
        public SGSRRenderPass(SGSR_URP _upscaler)
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            CoreUtils.SetRenderTarget(_cmd, _cameraTarget, RenderBufferLoadAction.DontCare, RenderBufferStoreAction.Store, ClearFlag.None, Color.clear);
